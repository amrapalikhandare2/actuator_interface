...
: ${AMENT_CURRENT_PREFIX:="/application/rightbot_ws/src/actuator_interface/install/motor"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motor/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motor/environment/path.sh"
